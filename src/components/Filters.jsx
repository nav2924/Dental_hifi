  ...
  return (
    <div className="filters-hero">
      ...
      <div className="filters-fee">
        ...
        <div className="zero-fivehundred">
          <input
            type="radio"
            id="zero-to-fivehundred"
            name="fee"
            value="0-500"
          />
        ...
        <div className="fivehundred-thousand">
          <input
            type="radio"
            id="fivehundred-to-thousand"
            name="fee"
            value="500-1000"
          />
