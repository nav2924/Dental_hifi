      ...
      <div className="bio-container">
        <div className="left-part">
          ...
          <div className="dr-services">
            Services: Dental Bonding, Dental Crowns, Bridge Works, Cosmetic
            Fillings, Invisalign
          </div>
          <div className="description">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus,
            quidem! Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Doloribus, quidem! Lorem ipsum dolor sit amet, consectetur
            adipisicing elit. Doloribus, quidem!
          </div>
        </div>
...
export default BioMumbaiEvent1;
